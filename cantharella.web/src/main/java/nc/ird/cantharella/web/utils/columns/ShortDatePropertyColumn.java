 ...
 * #%L
 * Cantharella :: Web
 * $Id: ShortDatePropertyColumn.java 269 2014-05-07 08:14:00Z echatellier $
 * $HeadURL: https://svn.codelutin.com/cantharella/trunk/cantharella.web/src/main/java/nc/ird/cantharella/web/utils/columns/ShortDatePropertyColumn.java $
 * %%
...
public class ShortDatePropertyColumn<T, S> extends AbstractColumn<T, S> implements IExportableColumn<T, S, Object> {
     ...
     */
    public ShortDatePropertyColumn(IModel<String> displayModel, S sortProperty, String propertyExpression, Locale locale) {
    ...
    public IModel<Object> getDataModel(IModel<T> rowModel) {
        return new DisplayShortDatePropertyModel(rowModel.getObject(), propertyExpression, locale);
    }
}
